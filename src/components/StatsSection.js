...
// Custom count-up hook triggered by visibility
...
export default function StatsSection() {
  ...
  return (
    <section id="stats" ref={ref} className="py-24 px-6 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-72 h-72 bg-yellow-300/10 blur-3xl rounded-full -z-10" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-yellow-400/20 blur-[120px] rounded-full -z-10" />
